""" Check if there are unsupported layers in the model, if yes logging.error and exit, if not logging.info """
...
def check_layers(net, device):
    logging.info("Checking if all layers in model are supported..")        
